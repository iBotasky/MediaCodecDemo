...
/**
 * For short duration video because of the memory isn't limit.
 * And we don't need to think about the I,P,B frames.
 * Created by liangbo.su@ubnt on 2019-07-15
 */
public class ReverseShortVideo {
    ...
    public ReverseShortVideo(String inputVideoFile, String outputVideoFile) {
